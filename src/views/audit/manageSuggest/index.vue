  ...
  <div class="page-container">
    ...
    <el-table :key="tableKey"
      ...
      <el-table-column type="selection"
                       align="center" />
      <el-table-column label="管理建议名称"
                       prop="manageSuggestName">
        <template slot-scope="scope">
          <el-link :underline="false"
                   type="primary"
                   @click="findManageSuggest(scope.row)">
    ...
    <el-dialog :append-to-body='true'
      ...
      <el-form ref="dataForm"
               ...
               class="detail-form">
        <el-form-item label="管理建议名称"
                      prop="manageSuggestName">
          <el-input v-model="temp.manageSuggestName"
        ...
        <el-form-item label="管理建议描述"
                      prop="manageSuggestDesc">
          <el-input v-model="temp.manageSuggestDesc"
