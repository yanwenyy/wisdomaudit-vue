    ...
    <div class="conter">
      ...
      <el-table :data="tableData_list"
        ...
        <el-table-column prop="findPeople"
                         ...
                         label="发现人">
          <template slot-scope="scope">
            <span v-if="scope.row.findPeople">
          ...
          if (valid) {
            ...
            let params = {
              ...
              entity: {
                ...
                dictname: this.add.special,//专题name
              },
