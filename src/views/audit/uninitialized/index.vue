  ...
  <div>
    ...
    <el-card>
      ...
      <el-form ref="form"
        ...
        <el-table ref="singleTable"
          ...
          <el-table-column poperty="name"
                           label="姓名"
                           width="280">
            <el-form-item>
              <el-select v-model="tableData.name"
                         placeholder="请选择活动区域">
                <el-option label="区域一"
          ...
          <el-table-column property="affUnit"
                           label="所属单位">
          </el-table-column>
          <el-table-column property="department"
                           label="所属部门">
          </el-table-column>
          <el-table-column property="contactPerson"
                           label="是否接口人"
                           width="150">
          </el-table-column>
        </el-table>
    ...
    <el-card>
      <el-row :gutter="24"
        ...
        <el-col :span="2">
          <el-button type="primary"
                     @click="addModelTask">添加模型任务</el-button>
        </el-col>
        <el-col :span="2">
          <el-button type="primary"
                     @click="addselfTask">添加自建任务</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button type="primary">删除</el-button>
        </el-col>
        <el-col :span="2">
          <el-button type="primary"
                     @click="assignPerson">分配责任人</el-button>
        </el-col>
      </el-row>
      <el-table :data="auditTab"
        ...
        <el-table-column property="modelTask"
                         label="模型任务名称"
                         width="200">
        </el-table-column>
        <el-table-column property="taskType"
                         label="任务类型"
                         width="280">
        </el-table-column>
        <el-table-column property="personLiable"
                         label="责任人">
        </el-table-column>
        <el-table-column property="taskDes"
                         label="任务描述"> </el-table-column>
        <el-table-column label="操作">
          <template>
            <el-button type="primary"
                       @click="setParameters">设置参数</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
    ...
    <el-card>
      ...
      <el-table :data="auditDataTab"
        ...
        <el-table-column property="secNumber"
                         label="二级编号">
        </el-table-column>
    ...
    <el-dialog title="模型列表"
      ...
      <el-card class="modelName">
        <el-row>
          <el-col :span="18">
            <el-form v-model="modelFrom"
                     label-width="80px"
                     label-position="right">
              <el-form-item label="模型名称">
                <el-input class="modelNameInput"
                          v-model="modelFrom.name"></el-input>
              </el-form-item>
            </el-form>
          </el-col>
          <el-col :span="5">
    ...
    <el-dialog :visible.sync="assignPersonDialogVisible"
      ...
      <el-card class="queryInput"
               style="height:80px; margin-bottom:1%">
            ...
            <el-col :span="6">
              <el-form-item label="年 度">
                <el-select placeholder="2021"
                  ...
                  <el-option label="2023"
                             value="2023"></el-option>
                  <el-option label="2024"
      ...
      <el-card style="height:65px; line-height:8px">
        <el-row>
          ...
          <el-col :span="4">
            <el-button type="primary"
                       style="margin:-5px 0 0 20px">引用</el-button>
          </el-col>
        </el-row>
      </el-card>
