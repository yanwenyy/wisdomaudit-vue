  ...
  <div class="audit-history">
    <div class="projectTab">
      <el-form :model="formState"
        ...
        <el-row>
          <el-col :span="7">
            <el-form-item label="历史审计发现描述："
                          name="describe"
                          prop="describe">
              <el-input v-model="formState.describe"
                        placeholder="请输入" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="发现人："
                          name="discoverer"
                          prop="discoverer">
              <el-input v-model="formState.discoverer"
                        placeholder="请输入" />
            </el-form-item>
          </el-col>
          <el-col :span="3">
      ...
      <el-row :gutter="24"
        ...
        <el-col :span="1.5">
          <el-button type="primary"
                     @click="addRow">新增省内历史审计发现</el-button>
        </el-col>
      </el-row>
      <!-- 表单 -->
      <el-table :data="tableData"
        ...
        <el-table-column prop="discoverer"
                         label="发现人">
        </el-table-column>
