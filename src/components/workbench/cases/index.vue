    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <div class="projectTab">
        ...
        <el-table :data="tableData" style="width: 100%" @select="Selects">
          ...
          <el-table-column prop="province" label="专题"> </el-table-column>
          <el-table-column prop="city" label="问题"> </el-table-column>
          <el-table-column prop="address" label="依据"> </el-table-column>
          <el-table-column prop="leixing" label="描述"> </el-table-column>
          <el-table-column prop="zip" label="风险金额(元)"> </el-table-column>
          ...
          <el-table-column prop="time" label="审计年度"> </el-table-column>

          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-link type="primary">编辑</el-link>
              <el-link type="danger" class="delete" @click="deletes(scope.row,scope.$index)">删除</el-link>
              <el-link type="primary" class="delete" @click="edit">下载</el-link>
